...
const Hero = () => {
  ...
  const four = (
    <p>
      ...
      developer with a goal-driven creative mindset and passion for learning and innovating. I love
      building things for the web. Outside work, I occasionally blog on{' '}
      <a href="https://medium.com/@apkc4545">Medium</a>.
    </p>
  );
  const five = (
